...
export default function StartupForm() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const response = await fetch("http://127.0.0.1:8000/api/register/startup/", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          company_mobile_number: form.companyMobile,
          owner_aadhar_card: form.ownerAadhar,
          dp_id_certificate: form.dpCertificate === "yes",
          dp_certificate_no: form.dpCertificate === "yes" ? form.dpCertificateNumber : "", // If "no", send empty string
          udyam_certificate: form.udyamCertificate === "yes",
          udyam_certificate_no: form.udyamCertificate === "yes" ? form.udyamCertificateNumber : "", // If "no", send empty string
      ...
      console.log("Startup registration successful:", data);
      ...
      <div>
        ...
        <div className="flex gap-3 mt-1 items-center">
          <select
            ...
            onChange={(e) => {
              update("dpCertificate", e.target.value);
              if (e.target.value === "no") update("dpCertificateNumber", "");
            }}
          >
        ...
        <div className="flex gap-3 mt-1 items-center">
          <select
            ...
            onChange={(e) => {
              ...
              if (e.target.value === "no") update("udyamCertificateNumber", "");
            }}
          >
            <option value="no">No</option>
            <option value="yes">Yes</option>
