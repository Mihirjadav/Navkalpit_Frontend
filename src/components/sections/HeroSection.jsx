...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-screen overflow-hidden pt-12 sm:pt-16 md:pt-24 lg:pt-32 pb-12 sm:pb-16 md:pb-20">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-linear-to-b from-slate-900 via-slate-900 to-black">
          <div className="absolute top-0 right-0 w-full h-full opacity-30">
            <div className="absolute top-2 sm:top-10 right-2 sm:right-20 w-48 sm:w-96 h-48 sm:h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
            <div
              className="absolute top-20 sm:top-40 left-2 sm:left-10 w-48 sm:w-96 h-48 sm:h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div
              className="absolute bottom-10 sm:bottom-20 right-1/2 w-48 sm:w-96 h-48 sm:h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
        ...
        {/* Content */}
        <div className="relative z-10 px-3 sm:px-6 md:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center min-h-[60vh] sm:min-h-[65vh] lg:min-h-[60vh]">
            {/* Left content */}
            <div className="space-y-4 sm:space-y-6 md:space-y-8 order-2 lg:order-1">
              ...
              {/* Description */}
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 leading-relaxed max-w-xl">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                {/* Image container */}
                <div className="relative bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-700/50 shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 h-48 sm:h-64 md:h-80 lg:h-[500px] flex items-center justify-center group">
                  <img
                    src="/bg.avif"
                    alt="3D Printer"
        ...
        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 z-10">
          <div className="animate-bounce">
            <svg
              className="w-5 sm:w-6 h-5 sm:h-6 text-slate-400"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <section className="relative w-full bg-linear-to-b from-slate-900 via-slate-900 to-black py-12 sm:py-16 md:py-24">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-48 sm:w-96 h-48 sm:h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-48 sm:w-80 h-48 sm:h-80 bg-purple-500/10 rounded-full blur-3xl"></div>

        <div className="relative z-10">
          {/* Header */}
          <div className="px-3 sm:px-6 md:px-8 mb-8 sm:mb-12 md:mb-16">
            <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-2 sm:mb-4">
                Featured Products
              </h2>
                ...
                <div className="px-3 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
                  <div className="max-w-7xl mx-auto">
                    ...
                    >
                      ...
                      >
                        <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 rounded-xl sm:rounded-2xl overflow-hidden bg-linear-to-br from-slate-700 to-slate-900 flex items-center justify-center group-hover:shadow-2xl group-hover:shadow-blue-500/30 transition-all duration-300">
                          <img
                            src={p.img}
                            alt={p.alt}
