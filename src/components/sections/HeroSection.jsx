...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-screen overflow-hidden pt-16 sm:pt-20 md:pt-28 lg:pt-32 pb-12 sm:pb-16 md:pb-20">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-linear-to-b from-slate-900 via-slate-900 to-black">
          <div className="absolute top-0 right-0 w-full h-full opacity-30">
            <div className="absolute top-5 sm:top-10 right-10 sm:right-20 w-48 sm:w-96 h-48 sm:h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
            <div
              className="absolute top-20 sm:top-40 left-5 sm:left-10 w-48 sm:w-96 h-48 sm:h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
        ...
        {/* Content */}
        <div className="relative z-10 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center min-h-[60vh] lg:min-h-[60vh]">
            {/* Left content */}
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                {/* Image container */}
                <div className="relative bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-700/50 shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 h-64 sm:h-80 md:h-96 lg:h-[500px] flex items-center justify-center group">
                  <img
                    src="/bg.avif"
                    alt="3D Printer"
      ...
      <section className="relative w-full bg-linear-to-b from-slate-900 via-slate-900 to-black py-12 sm:py-16 md:py-24">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-48 sm:w-80 md:w-96 h-48 sm:h-80 md:h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-48 sm:w-80 md:w-80 h-48 sm:h-80 md:h-80 bg-purple-500/10 rounded-full blur-3xl"></div>

        <div className="relative z-10">
          {/* Header */}
          <div className="px-4 sm:px-6 md:px-8 mb-10 sm:mb-12 md:mb-16">
            <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-3 sm:mb-4">
                Featured Products
              </h2>
                ...
                <div className="px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
                  <div className="max-w-7xl mx-auto">
                    ...
                    >
                      ...
                      >
                        <div className="relative h-64 sm:h-72 md:h-80 lg:h-96 rounded-2xl overflow-hidden bg-linear-to-br from-slate-700 to-slate-900 flex items-center justify-center group-hover:shadow-2xl group-hover:shadow-blue-500/30 transition-all duration-300">
                          <img
                            src={p.img}
                            alt={p.alt}
